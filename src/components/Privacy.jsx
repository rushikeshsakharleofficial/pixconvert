  ...
  <section className="py-20">
    <div className="container">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="section-title fade-in">Privacy Policy</h1>
      ...
      <div className="space-y-16">
        ...
        <div className="p-8 rounded-3xl bg-primary/5 border border-primary/10 fade-in delay-2 text-center">
          <h2 className="text-xl font-bold text-primary mb-2 flex items-center justify-center gap-2">
        ...
        <div className="pt-8 border-t border-border fade-in delay-7">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            ...
            <Link to="/contact" className="text-primary hover:underline font-semibold italic" style={{ display: 'inline-block', padding: '0.3rem 0' }}>
              contact form
            </Link>.
          </p>
        </div>
